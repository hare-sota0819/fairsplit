/*
  ...
  - A unique constraint covering the columns `[groupId,userId]` on the table `Member` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "Member" ADD COLUMN     "invitedEmail" TEXT;
